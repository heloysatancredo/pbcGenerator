...
let imageArr = [['<img src="../img/light-bulb_black.png" alt="Black light-bulb" " width="58px">', '<img src="../img/peace_black.png" alt="Black peace signal" width="58px">', '<img src="../img/cube_black.png" alt="Black cube" width="58px">'], ['<img src="../img/light-bulb.png" alt="White light-bulb" width="58px">', '<img src="../img/peace.png" alt="White peace signal" width="58px">', '<img src="../img/cube.png" alt="White cube" width="58px">'], ['<img src="../img/light-bulb.png" alt="White light-bulb with opacity of 0.3" width="58px" style="opacity: 0.3">', '<img src="../img/peace.png" alt="White peace signal with opacity of 0.3" width="58px" style="opacity: 0.3">', '<img src="../img/cube.png" alt="White cube with opacity of 0.3" width="58px" style="opacity: 0.3">']];
...
cardRequest.addEventListener("click", () => {
    //debugger;
    updateObj();
    if (userData.fullName === "" || userData.occupancy === "" || userData.email === "" || userData.linkedin === "" || userData.phone === "") {
        errorMsg.innerHTML = "Plase fill out ALL fields";
    }
    else if (userData.numCards == "" || isNaN(userData.numCards) || userData.numCards == "0") {
